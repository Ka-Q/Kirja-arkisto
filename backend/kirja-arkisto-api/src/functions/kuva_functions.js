function GetKuva(req) {
    let returnJson = {}
    let listOfValues = []

    let params = req.query;
    let keys = Object.keys(params);
    let query = "SELECT * FROM kuva WHERE (1=1)"
...
exports.GetKuva = GetKuva
exports.PostKuva = PostKuva
exports.DeleteKuva = DeleteKuva
exports.PutKuva = PutKuva