...
function GetOmatSarjat(req) {
    let returnJson = {}
    let listOfValues = []

    let params = req.query;
    let keys = Object.keys(params);
    let query = "SELECT * FROM oman_sarjan_kirjat WHERE (1=1)"
...
exports.GetOmatSarjat = GetOmatSarjat
exports.PostOmatSarjat = PostOmatSarjat
exports.DeleteOmatSarjat = DeleteOmatSarjat
exports.PutOmatSarjat = PutOmatSarjat