...
function GetValokuva(req) {
  ...
  let query = "SELECT * FROM valokuva WHERE (1=1)"
...
function PostValokuva(req) {
  ...
  let query = "INSERT INTO valokuva ("
...
function DeleteValokuva(req) {
  let where = req.body
  let whereKeys = Object.keys(where)

  let queryList = []

  let query = "DELETE FROM valokuva WHERE (1=1)"
...
exports.GetValokuva = GetValokuva
exports.PutValokuva = PutValokuva
exports.PostValokuva = PostValokuva
exports.DeleteValokuva = DeleteValokuva